...
run_physlite_daod_darshan_parallel_compression() {
    ...
    __run_physlite_daod_darshan \
        $NPROCS $FORMAT /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/DerivationFrameworkART/mc20_13TeV.410470.PhPy8EG_A14_ttbar_hdamp258p75_nonallhad.recon.AOD.e6337_s3681_r13167/AOD.27162646._000001.pool.root.1 $(realpath $CONFIG) $RELEASE
...
run_general_weak() {
    ...
    run_physlite_daod_darshan_parallel_compression "PHYSLITE" $NPROC $CONFIG $RELEASE
}

# Execute the main function
run_general_weak $1 $2 $3 $4 $5
